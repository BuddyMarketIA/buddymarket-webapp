...
const CUISINE_OPTIONS_KEYS = [
  ...
  { value: "Japonesa", key: "japanese", emoji: "🇯🇵" },
  { value: "China", key: "chinese", emoji: "🇨🇳" },
  { value: "India", key: "indian", emoji: "🇮🇳" },
  { value: "Francesa", key: "french", emoji: "🇫🇷" },
  { value: "Tailandesa", key: "thai", emoji: "🇹🇭" },
  { value: "Griega", key: "greek", emoji: "🇬🇷" },
  { value: "Marroquí", key: "moroccan", emoji: "🇲🇦" },
  { value: "Turca", key: "turkish", emoji: "🇹🇷" },
  { value: "Peruana", key: "peruvian", emoji: "🇵🇪" },
  { value: "Argentina", key: "argentinian", emoji: "🇦🇷" },
  { value: "Colombiana", key: "colombian", emoji: "🇨🇴" },
  { value: "Brasileña", key: "brazilian", emoji: "🇧🇷" },
  { value: "Coreana", key: "korean", emoji: "🇰🇷" },
  { value: "Vietnamita", key: "vietnamese", emoji: "🇻🇳" },
  { value: "Libanesa", key: "lebanese", emoji: "🇱🇧" },
  { value: "Americana", key: "american", emoji: "🇺🇸" },
  { value: "Portuguesa", key: "portuguese", emoji: "🇵🇹" },
  { value: "Alemana", key: "german", emoji: "🇩🇪" },
  { value: "Cubana", key: "cuban", emoji: "🇨🇺" },
  { value: "Mediterránea", key: "mediterranean", emoji: "🫒" },
  { value: "Nórdica", key: "nordic", emoji: "❄️" },
  { value: "Caribeña", key: "caribbean", emoji: "🌴" },
  { value: "Africana", key: "african", emoji: "🇦🇫" },
  { value: "Árabe", key: "arabic", emoji: "🧆" },
  { value: "Internacional", key: "international", emoji: "🌐" },
  { value: "Fusión", key: "fusion", emoji: "✨" },
];
  ...
  return (
    <div style={{ padding: "16px", maxWidth: "480px", margin: "0 auto", paddingBottom: "100px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px", gap: "12px" }}>
        ...
        {isAuthenticated && (
          <div style={{ flexShrink: 0, paddingTop: isFree ? "6px" : "0", display: "flex", gap: "8px", alignItems: "center" }}>
            {/* Instagram Import Button */}
            <button
              onClick={() => navigate("/app/recipes/instagram")}
              style={{
