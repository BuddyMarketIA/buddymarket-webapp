                  ...
                  {data.upcomingAppointments.map((item, i) => {
                    ...
                    return (
                      <div key={i} className="flex items-center gap-3 px-5 py-3 hover:bg-gray-50 transition-colors">
                        ...
                        <span className={`text-xs px-2 py-0.5 rounded-full flex-shrink-0 ${item.appt.modality === "online" ? "bg-blue-100 text-blue-700" : "bg-green-100 text-green-700"}`}>
                          {item.appt.modality === "online" ? "Online" : "Presencial"}
                        </span>
                      </div>
                    );
                  })}
