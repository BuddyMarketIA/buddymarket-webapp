    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <Card className="max-w-md w-full text-center p-8">
          ...
          <p className="text-gray-500 mb-6">Necesitas una cuenta para solicitar ser BuddyMaker.</p>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 flex items-center justify-center p-4">
        <div className="max-w-lg w-full text-center">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-orange-100 mb-6 text-left">
            <h3 className="font-semibold text-gray-900 mb-3">¿Qué puedes hacer como BuddyMaker?</h3>
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900">Registro BuddyMaker</span>
          </div>
          ...
          <CardContent className="p-6 sm:p-8">
            ...
            {step === 1 && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Tu perfil de creador</h2>
                  <p className="text-gray-500 mt-1">Esta información aparecerá en tu perfil público como BuddyMaker.</p>
                </div>
            ...
            {step === 2 && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Tu contenido</h2>
                  <p className="text-gray-500 mt-1">Cuéntanos sobre el tipo de recetas que creas.</p>
                </div>
                <div className="space-y-4">
                  <div>
                    <Label>Nicho de contenido *</Label>
                    <p className="text-xs text-gray-500 mb-2">¿En qué tipo de recetas te especializas?</p>
            ...
            {step === 3 && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Tus redes sociales</h2>
                  <p className="text-gray-500 mt-1">Comparte tus perfiles y el número de seguidores en cada plataforma.</p>
                </div>
                <div className="space-y-5">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-lg font-black text-gray-800">T</span>
                  ...
                  <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="font-medium text-gray-900">Blog / Web</span>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
            ...
            {step === 4 && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-500 mt-1">Cuéntanos por qué quieres ser BuddyMaker en BuddyMarket.</p>
                </div>
                <div className="space-y-4">
                  <div>
                  ...
                  <div className="bg-orange-50 rounded-2xl p-5 border border-orange-100">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {totalFollowers() > 0 && (
                        <div className="flex justify-between">
                          <span className="text-gray-500">Comunidad total</span>
