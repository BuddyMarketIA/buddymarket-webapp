      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "64px 24px" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 12, padding: "14px 18px" }}>
            <p style={{ fontSize: 13, color: "#166534", margin: 0 }}>
              <strong>Empresa titular:</strong> BUDDY MARKET IA, S.L. · CIF B-56.819.576 · Calle Villanueva 2, 3ºC, 28001, Madrid (España) · <a href="mailto:info@buddymarketapp.com" style={{ color: "#166534" }}>info@buddymarketapp.com</a>
            </p>
          </div>
        </div>
        ...
        <div style={{ background: "white", borderRadius: 20, padding: "48px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
          ...
          <Section id="section-3" number="3" title="Registro y cuenta de usuario">
            ...
            <P>El Usuario se compromete a proporcionar información veraz, actualizada y completa durante el registro, y a mantenerla actualizada. La cuenta es personal e intransferible. El Usuario es el único responsable de la confidencialidad de sus credenciales y de todas las actividades realizadas bajo su cuenta. Cualquier uso no autorizado deberá ser notificado de inmediato a BUDDYMARKET en <a href="mailto:info@buddymarketapp.com" style={{ color: ORANGE }}>info@buddymarketapp.com</a>.</P>
          ...
          <Section id="section-5" number="5" title="Tratamiento de datos de salud y perfil nutricional">
            ...
            <P>El Usuario tiene derecho a acceder, rectificar, suprimir, limitar el tratamiento, oponerse al mismo y solicitar la portabilidad de sus datos de salud. Para ejercer estos derechos, puede enviar un correo a <a href="mailto:info@buddymarketapp.com" style={{ color: ORANGE }}>info@buddymarketapp.com</a> adjuntando copia de su documento de identidad, o dirigirse por escrito a Calle Villanueva 2, 3ºC, 28001, Madrid. También puede presentar una reclamación ante la <a href="https://www.aepd.es" target="_blank" rel="noopener noreferrer" style={{ color: ORANGE }}>Agencia Española de Protección de Datos</a>.</P>
          </Section>
          ...
          <Section id="section-10" number="10" title="Protección de datos personales">
            ...
            <P>Para cualquier consulta sobre protección de datos, el Usuario puede dirigirse a <a href="mailto:info@buddymarketapp.com" style={{ color: ORANGE }}>info@buddymarketapp.com</a> o por escrito a Calle Villanueva 2, 3ºC, 28001, Madrid. También puede presentar una reclamación ante la <a href="https://www.aepd.es" target="_blank" rel="noopener noreferrer" style={{ color: ORANGE }}>Agencia Española de Protección de Datos</a>.</P>
          </Section>
          ...
          <div style={{ borderTop: "1px solid #f3f4f6", paddingTop: 24, marginTop: 8 }}>
            <p style={{ fontSize: 13, color: "#9ca3af", margin: 0 }}>
              ...
              <a href="mailto:info@buddymarketapp.com" style={{ color: ORANGE }}>info@buddymarketapp.com</a>
