    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-bold text-foreground">Carrefour</h3>
        </div>
      ...
      {isSearching && (
        <div className="flex flex-col items-center gap-3 py-6">
          ...
          <p className="text-sm text-muted-foreground">Buscando productos en Carrefour… {resolved}/{unpurchased.length}</p>
        </div>
      )}
        ...
        <>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                {notFoundItems.length > 0 && (
                  <p className="text-xs text-muted-foreground">{notFoundItems.length} no encontrados en Carrefour</p>
                )}
              </div>
              {totalPrice > 0 && (
          ...
          <div className="space-y-3 max-h-[45vh] overflow-y-auto pr-1">
            {confirmedItems.map((m) => (
              <div key={m.itemId} className="flex items-center gap-3 rounded-2xl border border-border/50 p-3 hover:border-blue-200 transition-all">
                {/* Product image */}
            ...
            {notFoundItems.map((m) => (
              <div key={m.itemId} className="flex items-center gap-3 py-2 opacity-40">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground/70 italic">No encontrado en Carrefour</p>
                </div>
                <a
