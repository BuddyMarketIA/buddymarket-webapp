...
export default function AppLayout({ children, title, showBack = false, onBack, headerRight, hideNav = false }: AppLayoutProps) {
  ...
  const NAV_ITEMS = [
    ...
    { key: "recomendaciones", label: "Recomendaciones", to: "/app/recommendations", matches: ["/app/recommendations"], icon: (active: boolean) => (<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? "#F97316" : "#9ca3af"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L15.09 8.26H22L17.55 12.52L19.64 18.78L12 14.52L4.36 18.78L6.45 12.52L2 8.26H8.91L12 2Z"/></svg>) },
